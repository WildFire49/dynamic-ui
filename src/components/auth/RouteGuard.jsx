  ...
  useEffect(() => {
    const checkAccess = () => {
      ...
      if (routeId) {
        ...
        hasPermission = userRoleCodes.some((role) =>
      ...
      >
        ...
        >
          <CardContent sx={{ p: 4 }}>
            ...
            <Typography
              variant="body1"
              sx={{ color: "#666", mb: 1, lineHeight: 1.6 }}
            >
            ...
            <Box sx={{ display: "flex", gap: 2, justifyContent: "center" }}>
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    background:
                      "linear-gradient(135deg, #1976D2 0%, #1BA3D3 100%)",
            ...
            {process.env.NODE_ENV === "development" && (
              <Box sx={{ mt: 3, p: 2, bgcolor: "#f5f5f5", borderRadius: 1 }}>
                ...
                >
                  Route: {routeId} | User Roles: {getUserRoles().join(", ")} |
