...
// Utilities - keep as regular imports
...
const StellarThinking = dynamic(
  () => import("../components/mui/StellarThinking"),
  { ssr: false }
);

const ChatSkeleton = dynamic(() => import("../components/mui/ChatSkeleton"), {
  ssr: false,
});

const InputWithRecording = dynamic(
  () => import("../components/mui/InputWithRecording"),
  { ssr: false }
);
