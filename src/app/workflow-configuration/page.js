...
const WorkflowConfigurationPage = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (!conversationId) {
        throw new Error(
          "No conversation ID available. Please start a new modification request."
        );
      }
          ...
          <Box sx={{ maxWidth: 630, mx: "auto" }}>
            ...
            >
              ...
              <Box sx={{ p: 2.8, color: "white", textAlign: "center" }}>
                ...
                >
                  <Box>
                    ...
                    >
                      Simply Describe your Workflow Modification and <br />
                      Watch MiFiX AI Generate New Workflow Real-time
                    </Typography>
                  </Box>
                </Box>
              </Box>
              ...
              <Box
                sx={{
                  background:
                    "linear-gradient(180deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,1) 20%)",
                  p: 3.5,
                  position: "relative",
                }}
              >
