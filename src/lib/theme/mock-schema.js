...
export const getActionSchema = () => [
  {
    ...
    desc_for_llm:
      "Simple welcome screen with app name and proceed button, hey, hello, goodmorning, I want to start Onboarding. I want to start journey",
  ...
  },
  {
    ...
    desc_for_llm:
      "Consent screen with video component and a button to capture user agreement after viewing. User wants to wants to give consent for loan and agree to it.",
  ...
  },
  {
    ...
    desc_for_llm:
      "Screen for mobile number verifications and verifying customer's mobile number. Takes 10-digit input and validates. Enter Customer Mobile Number to verify. Mobile number verifications",
  ...
  },
  {
    ...
    desc_for_llm:
      "Screen for entering OTP sent to user's mobile number. OTP verification screen. Confirm OTP. Validate OTP",
  ...
  },
  {
    ...
    desc_for_llm:
      "Screen for user to review their provided information before submission.",
  ...
  },
  {
    ...
    desc_for_llm:
      "Screen to select a secondary KYC document type from a dropdown.",
  ...
  },
  {
    ...
    desc_for_llm:
      "Screen for user to review the information they have provided.",
  ...
  },
  {
    ...
    desc_for_llm:
      "Screen for user to review their complete application before submission.",
    ...
    confirmation: {
      ...
      message:
        "You are about to submit your application. This action cannot be undone. Are you sure you want to proceed?",
    },
  },
  {
    ...
    desc_for_llm:
      "Screen for user to capture a live photo using the device camera.",
    ...
    ui_components: [
      {
        ...
        properties: {
          ...
          message:
            "Thank you for joining us. You can now explore all our features.",
        },
      },
    ],
  },
          ...
          options: [
            {
              ...
              value: "insurance",
              description: "Protect your loan against unforeseen events.",
            },
            {
              label: "Flexible Repayment",
              value: "flexi_repay",
              description: "Pay more when you can, less when you can't.",
            },
            {
              label: "Loan Top-Up",
              value: "top_up",
              description: "Get additional funds on your existing loan.",
            },
            {
              label: "Zero Prepayment Charges",
              value: "no_prepayment_fee",
              description: "Pay off your loan early without any penalty.",
            },
          ],
        },
      },
    ...
    ui_components: [
      {
        ...
        properties: {
          ...
          message:
            "We're currently verifying your documents. This should only take a moment. We'll automatically proceed once it's complete.",
        },
      },
      {
